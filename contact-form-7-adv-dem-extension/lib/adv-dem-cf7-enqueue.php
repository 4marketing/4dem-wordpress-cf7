...
/**
 * Enqueue scripts and styles for extension
 */
...
function adv_dem_cf7_admin_scripts() {
  wp_register_style( 'wpcf7-adv-dem-wp-admin-css', ADV_DEM_CF7_PLUGIN_URL . '/assets/css/adv-dem-cf7-admin.css', array(), ADV_DEM_CF7_VERSION, 'all' );
  wp_enqueue_style( 'wpcf7-adv-dem-wp-admin-css' );
}
add_action( 'admin_enqueue_scripts', 'adv_dem_cf7_admin_scripts' );
